...
// ---- Pipeline Stages (new granular deal stages) ----
export const PIPELINE_STAGES = [
  { key: "new", label: "New Lead", color: "#06B6D4" },
  { key: "qualification", label: "Qualification", color: "#6366F1" },
  { key: "processing", label: "Bank Processing", color: "#FBBF24" },
  { key: "sanctioned", label: "Sanctioned", color: "#8B5CF6" },
  { key: "disbursed", label: "Disbursed", color: "#10B981" },
  { key: "lost", label: "Lost", color: "#EF4444" },
];

// Legacy status (kept for backward-compat with existing stored leads)
